...
├── README.md
│
├── Week-01-Data-Cleaning/
│   └── Python & Pandas data cleaning assessment
│
├── Week-02-SQL/
│   └── SQL fundamentals and data analysis
│
├── Week-03-SQL-Subqueries/
│   └── SQL subqueries and advanced queries
│
├── Week-04-Azure-ADF-Data-Pipeline/
│   └── Azure Data Factory pipeline
│
├── Week-05-Spark-Questions/
│   └── Apache Spark / PySpark assessment
│
├── Week-06-Spark-Questions-2/
│   └── Advanced Spark / PySpark assessment
│
├── Week-07/
│   └── Week 7 assessment
│
